 ...
 * Original file: C:\\xampp\\htdocs\\race\\platforms\\android\\app\\src\\main\\aidl\\com\\android\\vending\\billing\\IInAppBillingService.aidl
 */
...
java.lang.String _arg2;
_arg2 = data.readString();
int _result = this.isPromoEligible(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
@Override public int isPromoEligible(int apiVersion, java.lang.String packageName, java.lang.String type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeString(packageName);
_data.writeString(type);
mRemote.transact(Stub.TRANSACTION_isPromoEligible, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_isPromoEligible = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
...
public int isPromoEligible(int apiVersion, java.lang.String packageName, java.lang.String type) throws android.os.RemoteException;
